...
{
    #[Route('/', name: 'holidays_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'holidays_new', methods: ['GET', 'POST'])]
    public function new(Request $request, HolidaysRepository $holidaysRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('holidays_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'holidays_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'holidays_edit', methods: ['GET', 'POST'])]
